<template>
  <LandingPageShell :landing="landing" :hero="page.hero">
    <LandingCardSection :title="page.blocks.overview.title">
      <p class="landing-text">{{ page.blocks.overview.text }}</p>
    </LandingCardSection>

    <LandingCardSection :title="page.blocks.tracking.title">
      <div class="landing-grid landing-grid--3">
        <article
          v-for="item in page.blocks.tracking.items"
          :key="item.title"
          class="landing-card"
        >
          <h3>{{ item.title }}</h3>
    ...
    <LandingCardSection :title="page.blocks.business.title">
      <ul class="landing-list">
        <li v-for="item in page.blocks.business.items" :key="item">{{ item }}</li>
      </ul>
    </LandingCardSection>
...
const page = landing.seoPages?.websiteAnalytics;
