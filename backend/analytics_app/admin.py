...
class PageViewAdmin(admin.ModelAdmin):
    list_display = ("id", "client", "session_id", "pathname", "duration_seconds", "max_scroll_depth", "created_at")
...
class ClickEventAdmin(admin.ModelAdmin):
    list_display = ("id", "client", "session_id", "page_pathname", "element_text", "created_at")
    list_filter = ("created_at",)
