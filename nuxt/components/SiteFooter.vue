<template>
  <footer id="footer" class="site-footer">
    <div class="footer-glow footer-glow--left" aria-hidden="true" />
    <div class="footer-glow footer-glow--right" aria-hidden="true" />

    <div class="footer-content">
      <div id="contacts" class="footer-anchor" aria-hidden="true" />
      <div id="footer-contacts" class="footer-anchor" aria-hidden="true" />
      ...
      <div class="footer-top">
        <section class="footer-brand">
          ...
          <p class="footer-copy">В© 2026 TrackNode. Р’СЃРµ РїСЂР°РІР° Р·Р°С‰РёС‰РµРЅС‹.</p>

          <p class="footer-legal">
            <a href="#">РџРѕР»РёС‚РёРєР° РєРѕРЅС„РёРґРµРЅС†РёР°Р»СЊРЅРѕСЃС‚Рё</a>
            <span>|</span>
            <a href="#">РЈСЃР»РѕРІРёСЏ РїРѕР»СЊР·РѕРІР°РЅРёСЏ</a>
          </p>
        </section>

        <section class="footer-menus" aria-label="РќР°РІРёРіР°С†РёСЏ С„СѓС‚РµСЂР°">
          <div class="footer-column">
            <h3>РџСЂРѕРґСѓРєС‚</h3>
            <ul>
              <li><a href="#features">Р’РѕР·РјРѕР¶РЅРѕСЃС‚Рё</a></li>
              <li><a href="#how">РљР°Рє СЌС‚Рѕ СЂР°Р±РѕС‚Р°РµС‚</a></li>
              <li><a href="#pricing">РўР°СЂРёС„С‹</a></li>
              <li>
                <a href="/login">
          ...
          <div class="footer-column">
            <h3>Р РµСЃСѓСЂСЃС‹</h3>
            <ul>
              <li><a href="#reviews">РћС‚Р·С‹РІС‹</a></li>
              <li><a href="#faq">FAQ</a></li>
              <li><a href="#footer-contacts">РџРѕРґРґРµСЂР¶РєР°</a></li>
              <li><a href="#footer-contacts">Р”РѕРєСѓРјРµРЅС‚Р°С†РёСЏ</a></li>
            </ul>
          </div>

          <div class="footer-column">
            <h3>РљРѕРјРїР°РЅРёСЏ</h3>
            <ul>
              <li><a href="#footer-contacts">РљРѕРЅС‚Р°РєС‚С‹</a></li>
              <li><a href="#footer-contacts">РџР°СЂС‚РЅС‘СЂР°Рј</a></li>
              <li><a href="#footer-contacts">Р’Р°РєР°РЅСЃРёРё</a></li>
              <li><a href="#footer-contacts">Рћ РЅР°СЃ</a></li>
            </ul>
          </div>
        </section>

        <section class="footer-contacts" aria-label="РљРѕРЅС‚Р°РєС‚С‹">
          ...
          <ul>
            ...
            <li>
              <span class="footer-contact-label">РўРµР»РµС„РѕРЅ</span>
              <a href="tel:+79017800504">+7-901-780-05-04</a>
            </li>
            <li>
              <span class="footer-contact-label">РђРґСЂРµСЃ</span>
              <span>Р РѕСЃСЃРёСЏ, РњРѕСЃРєРІР°, СѓР». Р›РµРЅРёРЅРіСЂР°РґСЃРєР°СЏ, 15</span>
            </li>
          </ul>

          <div class="footer-socials" aria-label="РЎРѕС†РёР°Р»СЊРЅС‹Рµ СЃРµС‚Рё">
      ...
      <div class="footer-bottom">
        <p>В© 2026 TrackNode. Р’СЃРµ РїСЂР°РІР° Р·Р°С‰РёС‰РµРЅС‹.</p>
        <p>
          <a href="#">РџРѕР»РёС‚РёРєР° РєРѕРЅС„РёРґРµРЅС†РёР°Р»СЊРЅРѕСЃС‚Рё</a>
          <span>|</span>
          <a href="#">РЈСЃР»РѕРІРёСЏ РїРѕР»СЊР·РѕРІР°РЅРёСЏ</a>
...
.site-footer {
  ...
  background:
    radial-gradient(
      115% 120% at 50% 104%,
      rgba(224, 233, 249, 0.88) 0%,
      rgba(238, 244, 255, 0.25) 56%,
      rgba(238, 244, 255, 0) 100%
    ),
    linear-gradient(
      180deg,
      rgba(246, 250, 255, 0.95) 0%,
      rgba(237, 244, 255, 0.9) 100%
    );
  box-shadow:
    inset 0 1px 0 rgba(255, 255, 255, 0.9),
    0 22px 52px rgba(53, 79, 122, 0.12);
...
.footer-glow--left {
  ...
  background:
    radial-gradient(
      circle,
      rgba(166, 198, 245, 0.44) 0%,
      rgba(166, 198, 245, 0.14) 44%,
      rgba(166, 198, 245, 0) 72%
    );
}
...
.footer-glow--right {
  ...
  background:
    radial-gradient(
      circle,
      rgba(151, 188, 243, 0.42) 0%,
      rgba(151, 188, 243, 0.15) 44%,
      rgba(151, 188, 243, 0) 72%
    );
}
...
.footer-socials a {
  ...
  height: 38px;
  border-radius: 11px;
  border: 1px solid rgba(186, 211, 245, 0.9);
  background:
    linear-gradient(
      180deg,
  ...
  box-shadow:
    inset 0 1px 0 rgba(255, 255, 255, 0.9),
    0 8px 15px rgba(84, 124, 184, 0.18);
  color: #4c85cf;
  display: inline-flex;
  align-items: center;
...
.footer-socials a:hover {
  ...
  border-color: rgba(145, 187, 241, 0.98);
  box-shadow:
    inset 0 1px 0 rgba(255, 255, 255, 0.9),
    0 10px 18px rgba(84, 124, 184, 0.23);
}
...
.footer-bottom {
  margin-top: 28px;
  padding-top: 16px;
  border-top: 1px solid rgba(205, 220, 244, 0.82);
  display: flex;
  flex-wrap: wrap;
  align-items: center;
  justify-content: space-between;
  gap: 12px;
  color: rgba(49, 61, 87, 0.74);
  font-size: 0.85rem;
  line-height: 1.35;
}
