  ...
  >
    ...
    <Teleport to="body">
      <div v-if="isMobileMenuOpen" class="mobile-menu-wrap lg:hidden">
        <button class="mobile-menu-overlay" type="button" aria-label="Р—Р°РєСЂС‹С‚СЊ РјРµРЅСЋ" @click="closeMobileMenu" />

        <aside class="mobile-menu-sheet" role="dialog" aria-modal="true" aria-label="РњРѕР±РёР»СЊРЅРѕРµ РјРµРЅСЋ">
          <div class="mobile-menu-head">
            <span>РњРµРЅСЋ</span>
            <button type="button" aria-label="Р—Р°РєСЂС‹С‚СЊ РјРµРЅСЋ" @click="closeMobileMenu">
